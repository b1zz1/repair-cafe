  ...
  return (
    <div className="relative">
      ...
      <input
        type={type}
        className={cn(
          "flex bg-purple.3 font-semibold placeholder:font-medium text-purple.5 h-12 w-full rounded-md px-3 py-1 text-base shadow-sm transition-colors placeholder:text-purple.4 focus-visible:outline-none focus-visible:ring-2 focus:ring-purple.5 disabled:cursor-not-allowed disabled:opacity-50 pl-10", // Ajuste o padding para acomodar o ícone
          className
        )}
        ref={ref}
        {...props}
